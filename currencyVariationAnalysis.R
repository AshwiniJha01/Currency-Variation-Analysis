# The idea I want to test is if all the currencies react to changes in USD in the same manner or some currencies react differently. How can I do this? If I use a currency's exchange rate with US as the value of the currency, what do I use as the value of USD?
